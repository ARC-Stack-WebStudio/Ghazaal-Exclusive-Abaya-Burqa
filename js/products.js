...
const products = [
    { id: 1, name: "Luxury Dubai Abaya", price: 2999, image: "./Clean Img/green1 (2).png" , imagetwo: "./Clean Img/green1 (3).png", imagethree: "./Clean Img/green1.png" , badge: "NEW", description: "Premium Dubai-style Abaya crafted with elegant fabric, luxury finishing and a modern Islamic fashion design. Perfect for casual wear, events and special occasions.", fabricDetails: ["Nida Fabric", "Premium Imported Material", "Soft & Comfortable", "Wrinkle Resistant"] },
    { id: 2, name: "Party Wear Abaya", price: 3499, image: "./Clean Img/blue1 (4).png",  imagetwo: "./Clean Img/blue1 (3).png", imagethree: "./Clean Img/blue1 (4).png", badge: "BEST SELLER", description: "An elegant party-wear Abaya with a refined silhouette and premium finish, made to make every special occasion feel graceful.", fabricDetails: ["Premium Nida Fabric", "Elegant Party Finish", "Lightweight & Flowing", "Comfortable All-Day Wear"] },
    { id: 3, name: "Bridal Abaya", price: 4999, image: "./Clean Img/black1 (2).png", imagetwo: "./Clean Img/black1 (3).png", imagethree: "./Clean Img/black1.png", description: "A luxurious bridal Abaya designed with timeless elegance, intricate finishing and a graceful drape for your memorable occasions.", fabricDetails: ["Luxury Imported Fabric", "Detailed Bridal Finish", "Soft Inner Lining", "Premium Tailoring"] },
    { id: 4, name: "Premium Burqa", price: 3999, image: "./Clean Img/brown1.png",  imagetwo: "./Clean Img/brown1 (2).png", imagethree: "./Clean Img/brown1 (3).png",  description: "A premium Burqa that balances modesty, comfort and a polished modern look for everyday and occasion wear.", fabricDetails: ["Breathable Premium Fabric", "Comfort-Fit Design", "Durable Stitching", "Easy-Care Material"] }
];
